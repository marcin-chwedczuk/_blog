...
- Slow build and testing. Slow deploy. (It is still a monolit just with a better
 code organization.)
...
improvements in area of distributed system development.

To sum app: using modules is always a good idea. Depending on your
